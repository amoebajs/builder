...
import { Component, Input, Group } from "#core";
...
export class BasicElement extends ReactComponent {
  ...
  @Input({ name: "borderStyle", group: "basic", displayName: "边框风格", useMap: PositionStringRules })
  layoutBorderStyle: Array<[Position, string]> = [[Position.All, "solid"]];

  @Input({ name: "borderColor", group: "basic", displayName: "边框颜色", useMap: PositionStringRules })
  layoutBorderColor: Array<[Position, string]> = [[Position.All, "transparent"]];

  @Input({ name: "borderWidth", group: "basic", displayName: "边框尺寸", useMap: PositionStringRules })
  layoutBorderWidth: Array<[Position, string]> = [];

  @Input({ name: "padding", group: "basic", displayName: "内边距", useMap: PositionStringRules })
  layoutPadding: Array<[Position, string]> = [];

  @Input({ name: "margin", group: "basic", displayName: "外边距", useMap: PositionStringRules })
